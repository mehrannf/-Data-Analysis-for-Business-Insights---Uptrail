...
This project analyzes customer sign-up data for Rapid Scale, a SaaS company, to identify data quality issues and provide insights into user acquisition patterns, marketing engagement, and subscription plan preferences.
...
- Google was the top acquisition source in October 2024 (7 new customers)
- Region data is missing for 10% of customers (30 records)
- Customers aged 35-54 are 49% more likely to opt-in to marketing
- Premium plan is most popular (99 customers), especially among 25-34 age group
- 29 customers contacted support within 2 weeks of sign-up
...
- Contact the project owner for any questions or access requests
